...
default_config = dict(
    ...
    env_params=dict(
        n_train_tasks=2, # number of distinct tasks in this domain, shoudl equal sum of train and eval tasks
        n_eval_tasks=2,
    ...
    algo_params=dict(
        ...
        num_iterations=1000000, # 500 number of data sampling / training iterates
